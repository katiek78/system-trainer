...
const GoalForm = ({ userId, formId, goalForm, forNewEntry = true,  }) => {
...
I want to achieve a<select className="mx-4 " onChange={handleToggleScoreTime}>
...
of 
{ isScore && 
        <input className="shadow appearance-none border rounded w-14 mx-3 mt-1 mb-2 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          type="text"
          maxLength="5"
          name="score"
          value={form.score}
