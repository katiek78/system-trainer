...
<div className="bg-white dark:bg-slate-800 py-5 px-5 rounded">
    ...
    <p className="font-mono">Please take a look around! You can add your image sets, journeys and systems here to keep them all in one place and practise them. You can log all your memory training here too and create your own training plan (or have one generated for you!). More features to come soon. Meanwhile, get a random training suggestion by clicking the button below!</p>
    </div>
